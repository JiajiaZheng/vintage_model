...
def monte_carlo_cal():
    ...
    #print os.getcwd()  
    np.savetxt('../results/MCS_sum_results/TiO2_MCS_sum_mean.csv',table_mean,delimiter = ',')
    np.savetxt('../results/MCS_sum_results/TiO2_MCS_sum_percent25.csv',table_percent25,delimiter = ',') 
    np.savetxt('../results/MCS_sum_results/TiO2_MCS_sum_percent975.csv',table_percent975,delimiter = ',') 
'''done'''  
